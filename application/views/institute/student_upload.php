        ...
        <div class="row"> 
            <div class="col-md-8 center">
                ...
                <div class="login-panel panel panel-default academic upload">                  
				    ...
				    <p><a href="<?php echo base_url().'Signup/download'; ?>" class="btn btn-primary btn-block login">DOWNLOAD</a></p>
				   
				    <p>To Upload bulk users download the CSV format and fill the details of students accordingly. CSV files are opened in Microsoft Excel </p>
				   ...
				   <br/>
				   <p><span> STUDENT MANUAL UPLOAD </span></p>
				   <p>Click below for the manul upload<br/>
					You have to put information manually</p>
				    <div class="file-upload fb">
					    <!-- <label for="upload" ></label>
					    <input id="upload" class="file-upload__input" type="file" name="file-upload"> -->
					    <a href="<?php echo base_url('Signup/add_students')   ?>" class="btn btn-primary btn-block login" title="">MANUAL UPLOAD</a>
					</div>
