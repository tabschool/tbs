 <div class="container">       
        <div class="row">           
            <div class="col-md-8 center">
                <div class="login-panel panel-default academic plan">                  
                   
                    <div class="panel-body blue-border first">
				   <h3>Congralutions!! Your Institute is now Registered with Tabschool Inc.</h3>
...
<form action="" method="post" >
                            ...
                            <button type="submit" class="btn btn-primary btn-block login">START RIGHT NOW</button>
