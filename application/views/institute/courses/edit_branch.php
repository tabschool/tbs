                    ...
                    <?php echo form_open(current_url(),array('method'=>'post','class'=>'ng-pristine ng-valid')); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label> </label>
                                <input id="branch_name" name="branch_name" value="<?php if(!empty($branch->branch_name)){ echo $branch->branch_name; }   ?>"  ng-model="class_info.class_code" class="form-control required ng-pristine ng-valid" type="text" name="class_code" id="class_code" placeholder="Branch Name" maxlength="45">
