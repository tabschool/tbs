                ...
                <div class="raply assiment">
        				...
        				<div class="img-round">
                          <?php if(!empty($teacher_info->coverImage)){ ?>
                                <img width="100px" src="<?php echo $teacher_info->coverImage; ?>" alt="">
                            <?php }else{ ?>
                                <img width="100px" src="<?php echo base_url('assets/frontend/'); ?>img/default-profile-pic.png" alt="">
                            <?php } ?>
                        </div>
        				 <p><span> <?php if(!empty($teacher_info->first_name)) echo  ucfirst($teacher_info->first_name); ?> <?php if(!empty($teacher_info->last_name)) echo  ucfirst($teacher_info->last_name); ?>  </span> 24 hrs ago</p>
