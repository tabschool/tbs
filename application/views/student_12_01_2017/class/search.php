...
<ul class="nav nav-tabs">
        ...
        <a  href="#1" data-toggle="tab">LIBRARY</a>
			...
			<li><a href="#5" data-toggle="tab">WIKIVERSITY</a>
			</li>
			<li><a href="#6" data-toggle="tab">COURSES</a>
			</li>
		</ul>
        ...
        <div class="tab-pane my-notes" id="3">
          <!-- Welcome -->
               <?php if (!empty($mynotes)) { ?> 
				...
				<?php } }else{  ?>
          <div class="alert alert-info"> No Feed Found.</div>
          <?php } ?>
            ...
            <div class="col-md-4">
				...
				<div class="login-panel panel panel-default "> 
				 <div class="panel-body">				
				<div class="img-round">
                  <img src="assets/img/user.png" alt="" align="left">
                </div>
