                         ...
                         <form  action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <?php if (!empty($records->coverImage)){ ?>
                                    <img id="image_upload_preview" width="150px" src="<?php echo $records->coverImage; ?>" alt="..." class="img-circle">
                                    
                                <?php }else{ ?>
                                    <img id="image_upload_preview"  width="150px" src="<?php echo base_url('assets/frontend/'); ?>img/default-profile-pic.png" alt="..." class="img-circle">
                                <?php } ?>
