...
class Books extends CI_Controller{
    ...
    public function index($offset = 0){
        ...
        $data['template'] = "admin/books/institutes";
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($this->book_model->insert('courses', $course_data)) {
    ...
    public function edit($course_id = 0) {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($this->book_model->update('courses', $course_data, array('id' => $course_id))) {
        ...
        $data['course'] = $this->book_model->get_row('courses', array('id' => $course_id));
    ...
    {         
        ...
        if ($this->book_model->delete('courses', array('id' => $course_id))) {
